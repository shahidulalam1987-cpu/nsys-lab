...
class PermissionRouteRegistry
{
    ...
    private function routeRules(): array
    {
        return [
            ...
            ['patterns' => ['admin/employee-dashboard', 'admin/employees*', 'admin/salary-days*', 'admin/employee-kpi*', 'admin/leaderboard*', 'admin/performance-targets*'], 'view' => ['employees.view'], 'write' => ['employees.manage']],
