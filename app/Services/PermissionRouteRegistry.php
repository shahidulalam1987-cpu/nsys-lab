...
class PermissionRouteRegistry
{
        ...
        return [
            ...
            [
                ...
                'items' => [
                    ...
                    ['key' => 'moderator_operations', 'label' => 'Moderator Operations', 'url' => '/admin/marketing-operations/moderator/operations', 'active' => ['/admin/marketing-operations/moderator/operations*'], 'permissions' => ['moderator_operations.view']],
                    ['key' => 'ad_manager_operations', 'label' => 'Ad Manager Operations', 'url' => '/admin/marketing-operations/ad-manager/operations', 'active' => ['/admin/marketing-operations/ad-manager/operations*'], 'permissions' => ['ad_manager_operations.view']],
                    ...
                    ['key' => 'performance_verification', 'label' => 'Performance Verification', 'url' => '/admin/performance-verification', 'active' => ['/admin/performance-verification*'], 'permissions' => ['agency_operations.verify']],
                    ['key' => 'employee_submissions', 'label' => 'Employee Submissions', 'url' => '/admin/employee-submissions', 'active' => ['/admin/employee-submissions*'], 'permissions' => ['agency_operations.verify'], 'badge' => 'pending_employee_submissions', 'badge_danger' => true],
            ...
            [
                ...
                'items' => [
                    ...
                    ['key' => 'notice_board', 'label' => 'Notice Board', 'url' => '/admin/employee-notices', 'active' => ['/admin/employee-notices*'], 'permissions' => ['employees.view']],
                    ...
                    ['key' => 'performance_dashboard', 'label' => 'Performance Dashboard', 'url' => '/admin/employee-kpi', 'active' => ['/admin/employee-kpi*'], 'permissions' => ['employees.view']],
                    ['key' => 'leaderboard', 'label' => 'Leaderboard', 'url' => '/admin/leaderboard', 'active' => ['/admin/leaderboard*'], 'permissions' => ['employees.view']],
                    ['key' => 'performance_targets', 'label' => 'Performance Targets', 'url' => '/admin/performance-targets', 'active' => ['/admin/performance-targets*'], 'permissions' => ['employees.manage']],
    ...
    public function roleDefaults(): array
    {
        return [
            ...
            'hr_manager' => [
                ...
                'final_settlement.manage', 'documents.view',
            ],
            'finance_manager' => [
    ...
    private function routeRules(): array
    {
        return [
            ...
            ['patterns' => ['admin/employee-dashboard', 'admin/employees*', 'admin/salary-days*', 'admin/employee-notices*', 'admin/employee-kpi*', 'admin/leaderboard*', 'admin/performance-targets*'], 'view' => ['employees.view'], 'write' => ['employees.manage']],
