...
@section('content')
    <h1>Submit Client Fund Payment</h1>

    <a class="btn" href="/client/salary-payments">Client Fund Payment History</a>
    ...
    <div class="card" style="margin-top:20px;">
        <form method="POST" action="/client/salary-payments" enctype="multipart/form-data">
            @csrf
            <p>Payment Date<br><input type="date" name="salary_month" value="{{ old('salary_month', now()->toDateString()) }}" required></p>
            ...
            <button class="btn" type="submit">Submit Client Payment</button>
        </form>
    </div>
@endsection
