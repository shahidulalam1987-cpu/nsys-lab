        ...
        <table>
            ...
            @forelse($assignments as $assignment)
                ...
                <tr>
                    ...
                    <td>{{ $latestPayroll ? (['upcoming' => 'Upcoming', 'unpaid' => 'Unpaid', 'partial' => 'Partially Paid', 'paid' => 'Paid'][$latestPayroll->calculated_status] ?? ucfirst($latestPayroll->calculated_status)) : 'Not Generated' }}</td>
