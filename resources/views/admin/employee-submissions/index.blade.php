                    ...
                    <tr>
                        ...
                        <td style="white-space:nowrap;">
                            ...
                            @if($submission->status === 'approved')
                                <form method="POST" action="/admin/employee-submissions/{{ $submission->id }}/merge" style="display:inline">@csrf<button class="btn" type="submit">Merge Report</button></form>
                            @endif
                        </td>
                    </tr>
                @empty
