...
<body>
    ...
    <p><strong>Company:</strong> {{ $dashboard['export_meta']['company'] }}</p>
    <p><strong>Applied Filters:</strong> {{ $dashboard['export_meta']['filters'] }}</p>
    <p><strong>Export Timestamp:</strong> {{ $dashboard['export_meta']['generated_at'] }}</p>
    <p><strong>Generated By:</strong> {{ $dashboard['export_meta']['generated_by'] }}</p>
